<footer class="footer">
    <div class="footer-middle">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        ...
                        <div class="social-icons">
                            ...
                            <a href="#" class="social-icon" target="_blank" title="Call Us"><i
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Page</h4><!-- End .widget-title -->
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2021 Ed Collection. All Rights Reserved.</p>
